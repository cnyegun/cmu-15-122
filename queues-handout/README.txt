...
Compiling C1 code with contracts:
   % cc0 -d -W queue.c1 queue-use.c1 queue-test.c1
   % ./a.out

Compiling C code with contracts:
   % gcc -DDEBUG -g -fsanitize=undefined -Wall -Wextra -Werror -Wshadow -std=c99 -pedantic queue.c queue-test.c
   % ./a.out

Compiling C code without contracts:
   % gcc -g -Wall -Wextra -Werror -Wshadow -std=c99 -pedantic queue.c queue-test.c

==========================================================

Create a tarball to submit with autolab.andrew.cmu.edu web interface:
